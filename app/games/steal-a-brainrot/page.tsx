...
export default function StealABrainrotPage() {
  const categories = [
    { name: "Rare items", desc: "Uncommon items and stronger listings.", count: 122 },
    { name: "Limited offers", desc: "Short-term deals and active posts.", count: 67 },
    { name: "Trending deals", desc: "Most viewed and fast-moving listings.", count: 58 },
    { name: "Looking for", desc: "Wanted posts from active players.", count: 34 },
  ];
  ...
  const sellers = [
    { name: "DxTrader", trust: 92, listings: 10 },
    { name: "NovaTrade", trust: 91, listings: 8 },
    { name: "VantaSell", trust: 90, listings: 9 },
  ];
  ...
  return (
    <div className="relative min-h-screen bg-[#0B0B12] text-[#F5F7FF]">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(249,115,22,0.14),transparent_35%),radial-gradient(circle_at_top_right,rgba(239,68,68,0.10),transparent_28%)] pointer-events-none" />
            ...
            <div className="p-8 lg:p-10">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
                  ...
                  <div className="mt-1 text-lg font-bold">281</div>
                </div>
                <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
                  <div className="text-xs text-[#9CA3AF]">Verified sellers</div>
                  <div className="mt-1 text-lg font-bold">37</div>
                </div>
                <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
                  <div className="text-xs text-[#9CA3AF]">Wanted items</div>
                  <div className="mt-1 text-lg font-bold">74</div>
                </div>
              </div>
            ...
            <div className="min-h-[280px] border-t border-white/8 bg-[radial-gradient(circle_at_top,rgba(249,115,22,0.22),transparent_40%),linear-gradient(135deg,rgba(249,115,22,0.16),rgba(239,68,68,0.10))] lg:border-l lg:border-t-0">
              <div className="flex h-full items-end p-8">
                <div className="w-full rounded-[24px] border border-white/10 bg-black/20 p-5 backdrop-blur">
                  ...
                  <div className="mt-2 text-2xl font-bold">Collector Bundle</div>
                  <div className="mt-1 text-sm text-[#9CA3AF]">Trending deal • Trust score 90</div>
<Link
  href="/listing"
        ...
        <section className="mt-8 rounded-[26px] border border-white/10 bg-[#131320] p-5">
          <div className="grid gap-4 lg:grid-cols-6">
            ...
            <select className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white outline-none">
              ...
              <option>Limited offers</option>
              <option>Trending deals</option>
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            {categories.map((cat) => (
              ...
              >
                ...
                <div className="mt-4 text-sm text-orange-300">{cat.count} listings</div>
              </div>
            ))}
          </div>
        </section>
