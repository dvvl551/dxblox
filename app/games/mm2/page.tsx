...
const categories = [
  { name: "Knives", desc: "Rare knives and high-demand blades." },
  { name: "Guns", desc: "Popular weapons and clean listings." },
  { name: "Bundles", desc: "Grouped offers and special packs." },
...
export default function MM2Page() {
  ...
  useEffect(() => {
    const fetchMM2Listings = async () => {
      ...
      const mm2Listings = (data ?? []) as Listing[];
      setListings(mm2Listings);

      const uniqueUserIds = [...new Set(mm2Listings.map((item) => item.user_id))];
                ...
                <div className="w-full rounded-[24px] border border-white/10 bg-black/20 p-5 backdrop-blur">
                  {featuredListing ? (
                    ...
                    <>
                      ...
                      <div className="mt-1 text-sm text-[#9CA3AF]">
                        Create the first MM2 listing on Dxblox.
                      </div>
                      <Link
                        href="/create-listing"
                        className="mt-5 block w-full rounded-2xl bg-white/10 px-4 py-3 text-center font-semibold text-white transition hover:bg-white/15"
        ...
        <section className="mt-6 rounded-[26px] border border-white/10 bg-[#131320] p-5">
          <div className="grid gap-4 lg:grid-cols-6">
            ...
            >
              ...
              <option value="Knives" className="bg-[#131320] text-white">
                Knives
              </option>
              <option value="Guns" className="bg-[#131320] text-white">
                Guns
              </option>
        ...
        <section className="mt-10 grid gap-8 xl:grid-cols-[1fr_320px]">
          <div>
            ...
            {loading ? (
              ...
              <div className="rounded-[24px] border border-white/10 bg-[#131320] p-6 text-[#9CA3AF]">
                No MM2 listings match your filters yet.
              </div>
            ) : (
