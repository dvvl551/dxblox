...
const categories = [
  { name: "Pets", desc: "Popular pets and rare active listings." },
  { name: "Eggs", desc: "Egg listings and wanted posts." },
  { name: "Vehicles", desc: "Vehicles and premium bundles." },
      ...
      <main className="relative mx-auto max-w-7xl px-6 py-10">
        ...
        <section className="overflow-hidden rounded-[30px] border border-white/10 bg-[#131320]">
          <div className="grid lg:grid-cols-[1.2fr_0.8fr]">
            ...
            <div className="min-h-[280px] border-t border-white/8 bg-[radial-gradient(circle_at_top,rgba(236,72,153,0.22),transparent_40%),linear-gradient(135deg,rgba(236,72,153,0.16),rgba(168,85,247,0.10))] lg:border-l lg:border-t-0">
                ...
                <div className="w-full rounded-[24px] border border-white/10 bg-black/20 p-5 backdrop-blur">
                  {featuredListing ? (
                    ...
                    <>
                      ...
                      <div className="mt-1 text-sm text-[#9CA3AF]">
                        Create the first Adopt Me listing on Dxblox.
                      </div>
                      <Link
                        href="/create-listing"
                        className="mt-5 block w-full rounded-2xl bg-white/10 px-4 py-3 text-center font-semibold text-white transition hover:bg-white/15"
        ...
        <section className="rounded-[26px] border border-white/10 bg-[#131320] p-5">
          <div className="grid gap-4 lg:grid-cols-6">
            ...
            >
              ...
              <option value="Pets" className="bg-[#131320] text-white">
                Pets
              </option>
              <option value="Eggs" className="bg-[#131320] text-white">
                Eggs
              </option>
              <option value="Vehicles" className="bg-[#131320] text-white">
                Vehicles
              </option>
        ...
        <section className="mt-10 grid gap-8 xl:grid-cols-[1fr_320px]">
          <div>
            ...
            {loading ? (
              ...
              <div className="rounded-[24px] border border-white/10 bg-[#131320] p-6 text-[#9CA3AF]">
                No Adopt Me listings match your filters yet.
              </div>
            ) : (
