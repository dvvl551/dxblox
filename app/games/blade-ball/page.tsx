...
const categories = [
  { name: "Swords", desc: "Popular swords and high-demand blades." },
  { name: "Finishers", desc: "Kill effects and finishing animations." },
...
export default function BladeBallPage() {
  ...
  useEffect(() => {
    const fetchBladeBallListings = async () => {
      ...
      const bladeBallListings = (data ?? []) as Listing[];
  ...
  return (
    <div className="relative min-h-screen bg-[#0B0B12] text-[#F5F7FF]">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(61,169,252,0.14),transparent_35%),radial-gradient(circle_at_top_right,rgba(124,92,255,0.10),transparent_28%)]" />
...
<option value="Swords" className="bg-[#131320] text-white">
  Swords
</option>
<option value="Finishers" className="bg-[#131320] text-white">
  Finishers
</option>
